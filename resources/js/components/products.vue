            ...
            <div class="row">
                <div class="col-md-4 " v-for="product in products">
                    <div class="probootstrap-card with-hover">
                        <div class="probootstrap-card-media"><a v-bind:href="product.link"><img
                            v-bind:src="product.image"
                            class="img-responsive img-border"></a>
                        </div>
                        <div class="probootstrap-card-text "><a v-bind:href="product.link"><h2
                            class="probootstrap-card-heading mb0 font-weight-bold ">
                            {{product.title}}</h2></a>
                            <p class="muted">{{product.category.name}} <span
                                class="pull-right">{{product.price}} DT </span></p>
                        </div>
                    </div>
                </div>
